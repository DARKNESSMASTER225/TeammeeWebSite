...
document.addEventListener("DOMContentLoaded", function () {
            ...
            const baseUrl = '/tariff/checkout/?tariff=Тариф Для компактной команды (на 1 мес.)&tariff_id=2&payment_amount='
...
document.addEventListener("DOMContentLoaded", function () {
            ...
            const delta = 1000; // Дельта между тарифами
            const baseUrl = '/tariff/checkout/?tariff=Тариф Для большой команды. (на 1 мес.)&tariff_id=3&payment_amount='
...
document.addEventListener("DOMContentLoaded", function () {
            ...
            const initialPrice = 1500; // Изначальная цена
            const delta = 500; // Дельта между тарифами
            const baseUrl = '/tariff/checkout/?tariff=Тариф Для небольшой команды (на год - 12 мес.)&tariff_id=5&payment_amount='
...
document.addEventListener("DOMContentLoaded", function () {
            ...
            const initialPrice = 2000; // Изначальная цена
            const delta = 1000; // Дельта между тарифами
            const baseUrl = '/tariff/checkout/?tariff=Тариф Для компактной команды (на год - 12 мес.)&tariff_id=6&payment_amount='
...
document.addEventListener("DOMContentLoaded", function () {
            ...
            const initialPrice = 4000; // Изначальная цена
            const delta = 1000; // Дельта между тарифами
            const baseUrl = '/tariff/checkout/?tariff=Тариф Для большой команды (на год - 12 мес.)&tariff_id=7&payment_amount='
